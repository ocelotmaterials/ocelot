...
class Material(Atom):
    ...
    def write_yaml(self):
        ...
        print("cell:")
        print("-  [{:.12f},  {:.12f},  {:.12f}]".format(self.bravais_lattice[0][0], self.bravais_lattice[0][1], self.bravais_lattice[0][2]))
        print("-  [{:.12f},  {:.12f},  {:.12f}]".format(self.bravais_lattice[1][0], self.bravais_lattice[1][1], self.bravais_lattice[1][2]))
        print("-  [{:.12f},  {:.12f},  {:.12f}]".format(self.bravais_lattice[2][0], self.bravais_lattice[2][1], self.bravais_lattice[2][2]))
        print("atoms:")
